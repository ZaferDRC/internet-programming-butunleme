    ...
    <section class="icerik">
        ...
        if (isset($_POST["gonder"])) { 
            ...
            if (!is_numeric($_POST['tel'])) {
                ...
                $sql = "INSERT INTO iletisim(isim,mail,tel,mesaj) VALUES(?, ?, ?,?)"; 

                $baglandb 
                    ->prepare($sql) 
                    ->execute([$_POST["isim"], $_POST["mail"], $_POST["tel"], $_POST["mesaj"]]); 
        ...
        <form action="" method="POST">
            ...
            <input type="email" name="mail" placeholder="Email Adresiniz:">
            <input type="tel" name="tel" maxlength="10" placeholder="Telefon Numaranız:">
